...
set :application, "gatsbythailand"
set :repo_url, "ssh://git@128.199.130.27:/home/git/git-repo/gatsby.git"
...
append :linked_files, 'app/config/parameters.yml', 'web/robots.txt'
# append :linked_files, "config/database.yml", "config/secrets.yml"

# Default value for linked_dirs is []
append :linked_dirs, 'web/uploads', 'web/media', 'data/banks', 'data/excel', 'var/browscapcache'
