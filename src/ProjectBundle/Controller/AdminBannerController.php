  ...
  */
  public function updateAction(Request $request)
  {
    ...
    if ($form->isSubmitted() && $form->isValid()) {
			...
			if($request->get('removefileimage_admin_banner_translations_en_image')==1){
				$data->translate('en')->setImage(null);
			}

			if($request->get('removefileimage_admin_banner_translations_en_imageMobile')==1){
				$data->translate('en')->setImageMobile(null);
			}

			if($request->get('removefileimage_admin_banner_translations_th_image')==1){
				$data->translate('th')->setImage(null);
			}

			if($request->get('removefileimage_admin_banner_translations_th_imageMobile')==1){
				$data->translate('th')->setImageMobile(null);
			}
