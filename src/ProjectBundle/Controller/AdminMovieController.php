...
use ProjectBundle\Form\Type\AdminMovieType;
use ProjectBundle\Form\Type\AdminSearchMovieType;
...
class AdminMovieController extends Controller
{
	...
	*/
	public function indexAction(Request $request)
	{
		...
		$form_search = $this->createForm(AdminSearchMovieType::class, null, array('allow_extra_fields'=>true));
		$form_search->handleRequest($request);

		$arr_query_data = $request->query->get('admin_search_movie');
	...
	*/
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm(AdminMovieType::class, new Movie());
	...
	*/
	public function createAction(Request $request)
	{
		...
		$data = new Movie();
		$form = $this->createForm(AdminMovieType::class, $data);
	...
	*/
	public function editAction(Request $request)
	{
		$util = $this->container->get('utilities');
		$util->setCkAuthorized();
		$data = $this->getDoctrine()->getRepository(Movie::class)->find($request->get('id'));
	...
	*/
	public function updateAction(Request $request)
	{
		...
		$data = $em->getRepository(Movie::class)->find($request->get('id'));
		if (!$data) { throw $this->createNotFoundException('No data found'); }
	...
	public function group_deleteAction(Request $request)
	{
		...
		if ($data_ids) {
			...
			foreach ($data_ids as $data_id) {
				$data = $em->getRepository(Movie::class)->find($data_id);
				if ($data) {
					try {
						$em->remove($data);
						$em->flush();
