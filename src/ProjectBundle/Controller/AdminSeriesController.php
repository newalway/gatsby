...
use ProjectBundle\Form\Type\AdminSeriesType;
use ProjectBundle\Form\Type\AdminSearchCategoryType;
...
class AdminSeriesController extends Controller
{
	...
	*/
	public function indexAction(Request $request)
	{
		...
		$form_search = $this->createForm(AdminSearchCategoryType::class, null, array('allow_extra_fields'=>true));
		$form_search->handleRequest($request);

		$arr_query_data = $request->query->get('admin_search_category');
