...
class AdminPageTermsConditionsController extends Controller
{
    const ROUTER_INDEX = 'admin_page_terms_conditions';
    const ROUTER_CONTROLLER = 'AdminPageTermsConditions';
