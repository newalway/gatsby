...
class Collections
{
	...
	public static function wordTemplate($template)
	{
		switch($template){
			case 'default':
				$return_template = 'Default template';
				break;
			case 'movingRubber':
				$return_template = 'Moving rubber template';
				break;
			case 'stylingPomade':
				$return_template = 'Styling Pomade template';
				break;
			case 'hairJam':
				$return_template = 'Hair Jam template';
				break;
	...
	public static function wordPaymentStatus($status)
	{
		...
		switch($status){
			case 'Awaiting payment':
				$return_status = '<span class="label label-warning">Awaiting payment</span>';
				break;
			case 'Paid':
