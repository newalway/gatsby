 ...
 * Video
 *
 * @ORM\Table(name="styling")
 * @ORM\Entity(repositoryClass="ProjectBundle\Repository\StylingRepository")
...
class Styling
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Series", inversedBy="styling")
     * @ORM\JoinColumn(name="serie_id", referencedColumnName="id")
     */
    protected $series;

    /**
    * @ORM\ManyToOne(targetEntity="ProductCategory", inversedBy="styling")
