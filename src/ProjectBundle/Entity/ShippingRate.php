...
class ShippingRate
{
    ...
    /**
     * @ORM\Column(name="rate_amount", type="integer", nullable = true)
     */
    private $rateAmount;
    ...
    /**
     * @ORM\Column(name="free_shipping", type="boolean", options={"unsigned":true, "default":0})
     */
    ...
    /**
     * Get the value of Free Shipping
     *
     * @return mixed
     */
    ...
    /**
     * Set the value of Free Shipping
     *
