...
// $config['licenseKey']  = 'Q939M2JEVJH2MW6VLYJV5A2YTE3GF';
// $config['licenseName'] = 'localhost';
// $config['licenseKey']  = 'JVUV8FM99AFTJAE9D1TM4P6SW32GP';
///// gatsby
$config['licenseName'] = '104.248.152.195';
$config['licenseKey']  = 'VSJSL11B6MG1A7L4AVGMQN7653CKE';
// $config['licenseName'] = 'gatsbythailand.com';
// $config['licenseKey']  = '8STS6LKEW5T7AX3PK1F1L6EX7CXBY';

// $config['licenseName'] = 'acseine.in.th';
// $config['licenseKey']  = '4TYT77W153BQA61G9L3FPVKRQWRDT';
// $config['licenseName'] = 'preview.acseine.in.th';
// $config['licenseKey']  = 'ABPBULL155WHT69113JW6LA5RRKK5';
