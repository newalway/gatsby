 ...
 */
class Version20181019031936 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE customer_payment_epayment (id INT AUTO_INCREMENT NOT NULL, customer_order_id INT DEFAULT NULL, amount NUMERIC(10, 2) NOT NULL, status VARCHAR(45) NOT NULL, updated_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_5D0A3AB1A15A2E17 (customer_order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) DEFAULT NULL, position SMALLINT UNSIGNED DEFAULT 0 NOT NULL, updated_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE series (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE showroom (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) DEFAULT NULL, latitude VARCHAR(255) DEFAULT NULL, longitude VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, fax VARCHAR(255) DEFAULT NULL, mobile VARCHAR(255) DEFAULT NULL, position SMALLINT NOT NULL, status SMALLINT NOT NULL, updated_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE customer_order_item (id INT AUTO_INCREMENT NOT NULL, customer_order_id INT DEFAULT NULL, product_id INT DEFAULT NULL, sku_id INT DEFAULT NULL, product_title VARCHAR(255) NOT NULL, price NUMERIC(10, 2) DEFAULT NULL, compare_at_price NUMERIC(10, 2) DEFAULT NULL, discount NUMERIC(10, 2) DEFAULT NULL, quantity INT DEFAULT NULL, amount NUMERIC(10, 2) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, inventory_policy_status SMALLINT UNSIGNED DEFAULT 0 NOT NULL, sku_title LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_AF231B8BA15A2E17 (customer_order_id), INDEX IDX_AF231B8B4584665A (product_id), INDEX IDX_AF231B8B1777D41C (sku_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
