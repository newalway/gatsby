 ...
 */
class Version20181210071555 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE customer_order ADD is_read SMALLINT UNSIGNED DEFAULT 0 NOT NULL');
        ...
        $this->addSql('CREATE INDEX customer_order_order_payment_option_1 ON customer_order (payment_option)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX customer_order_order_payment_option_1 ON customer_order');
        $this->addSql('DROP INDEX customer_order_order_is_read_1 ON customer_order');
        $this->addSql('ALTER TABLE customer_order DROP is_read');
        $this->addSql('ALTER TABLE product CHANGE is_new is_new TINYINT(1) DEFAULT \'0\' NOT NULL');
        $this->addSql('ALTER TABLE sku CHANGE default_option default_option TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
}
